package uk.co.baremedia.gnomo.mobile.core
{
	...
	public class CoreAppScreens
	{
		public static function getAppScreens(firstScreenName:String):DescriptoViews
		{
			...
			screens.push( new VOScreen(ComponentsTryAgain, MediatorScreenTryAgain, EnumsScreens.SCREEN_PHONE, EnumsViewNavigation.TYPE_SCREEN) );
			screens.push( new VOScreen(ComponentsDisconnected, MediatorScreenDisconnected, EnumsScreens.SCREEN_DISCONNECTED, EnumsViewNavigation.TYPE_POPUP) );
